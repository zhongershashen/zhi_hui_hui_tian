...
/**
 * \if ENGLISH_LANG
 * the describe of {@link FinalVar#EVENT_IVS_TRAFFIC_WRONGROUTE} 's data
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_TRAFFIC_WRONGROUTE} (交通违章-不按车道行驶)对应的数据块描述信息
 * \endif
 */
public class DEV_EVENT_TRAFFIC_WRONGROUTE_INFO implements Serializable {
	/**
	 *
	 */
