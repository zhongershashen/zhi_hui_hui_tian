...
/**
 * \if ENGLISH_LANG
 * Move event, the corresponding {@link FinalVar#EVENT_IVS_MOVEDETECTION}
 * \else
 * 移动事件, 对应 {@link FinalVar#EVENT_IVS_MOVEDETECTION}
 * \endif
 */
public class DEV_EVENT_MOVE_INFO implements Serializable {
	/**
	 *
	 */
	 ...
	 * \endif
	 */
	public SDK_POINT            stuTrackLine[] = new SDK_POINT[FinalVar.SDK_MAX_TRACK_LINE_NUM];
