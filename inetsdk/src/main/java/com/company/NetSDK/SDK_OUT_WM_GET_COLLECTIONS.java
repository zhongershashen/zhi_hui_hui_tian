...
/**
 * \if ENGLISH_LANG
 * {@link INetSDK#GetMonitorWallCollections} 's interface output param(get plan infomation of monitor wall)
 * \else
 * {@link INetSDK#GetMonitorWallCollections} 接口输出参数(获取电视墙预案信息)
 * \endif
 */
