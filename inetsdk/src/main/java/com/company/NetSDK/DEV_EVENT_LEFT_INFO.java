...
/**
 * \if ENGLISH_LANG
 * the describe of {@link FinalVar#EVENT_IVS_LEFTDETECTION}'s data
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_LEFTDETECTION} (物品遗留事件)对应的数据块描述信息
 * \endif
 */
public class DEV_EVENT_LEFT_INFO implements Serializable {
	/**
	 *
	 */
