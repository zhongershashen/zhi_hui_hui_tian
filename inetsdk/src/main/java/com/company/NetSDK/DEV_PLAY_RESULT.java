...
/**
 * \if ENGLISH_LANG
 * Request monitoring or playback's return information, the corresponding command {@link FinalVar#SDK_REALPLAY_FAILD_EVENT}
 * \else
 * 请求监视或回放错误的返回信息, 对应命令 {@link FinalVar#SDK_REALPLAY_FAILD_EVENT}
 * \endif
 */
