...
/**
 * \if ENGLISH_LANG
 * Event type {@link FinalVar#EVENT_IVS_TRAFFIC_IDLE} (idle)corresponding data block description info
 * \else
 * 事件类型  {@link FinalVar#EVENT_IVS_TRAFFIC_IDLE} (交通空闲事件)对应数据块描述信息
 * \endif
 */
