...
/**
 * \if ENGLISH_LANG
 * the describe of {@link FinalVar#EVENT_IVS_TRAFFIC_OVERLINE} 's data
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_TRAFFIC_OVERLINE} (交通-压线事件)对应的数据块描述信息
 * \endif
 */
public class DEV_EVENT_TRAFFIC_OVERLINE_INFO implements Serializable {
	/**
	 *
	 */
