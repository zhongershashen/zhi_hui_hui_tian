...
/**
 * \if ENGLISH_LANG
 * the describe of {@link FinalVar#EVENT_IVS_TRAFFIC_DRIVINGONSHOULDER} 's data
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_TRAFFIC_DRIVINGONSHOULDER} (交通违章-路肩行驶事件)对应的数据块描述信息
 * \endif
 */
public class DEV_EVENT_TRAFFIC_DRIVINGONSHOULDER_INFO implements Serializable {
	/**
	 *
	 */
