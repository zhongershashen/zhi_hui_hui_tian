...
/**
 * \if ENGLISH_LANG
 * Event type {@link FinalVar#EVENT_IVS_TRAFFIC_PEDESTRAIN} (pedestrain)corresponding data block description info
 * \else
 * 事件类型  {@link FinalVar#EVENT_IVS_TRAFFIC_PEDESTRAIN} (交通行人事件)对应数据块描述信息
 * \endif
 */
public class DEV_EVENT_TRAFFIC_PEDESTRAIN_INFO implements Serializable {
	/**
	 *
	 */
