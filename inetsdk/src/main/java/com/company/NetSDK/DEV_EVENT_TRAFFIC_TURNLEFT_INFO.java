...
/**
 * \if ENGLISH_LANG
 * the describe of {@link FinalVar#EVENT_IVS_TRAFFIC_TURNLEFT} 's data
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_TRAFFIC_TURNLEFT} (交通-违章左转)对应的数据块描述信息
 * \endif
 */
public class DEV_EVENT_TRAFFIC_TURNLEFT_INFO implements Serializable {
	/**
	 *
	 */
