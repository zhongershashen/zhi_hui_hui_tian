...
public class INetSDK
{
	 ...
	 * \else
	 * 退出设备
	 * @param lLoginID {@link INetSDK#LoginWithHighLevelSecurity}的返回值
	 * @return true:成功, false:失败
	 * \endif
	 * @see {@link INetSDK#Login}
	 */
	 ...
	 * <tr><td>CFG_CMD_AIO_APP_CONFIG</td><td>"AIOAppConfig"</td><td>渝北智慧天网参数设置(对应结构体 CFG_AIO_APP_CONFIG_INFO)</td></tr>
	 * </table>
	 ...
	 * @param lLoginID {@link INetSDK#LoginWithHighLevelSecurity} return value
	 * @param nChannelID Channel no.
	 ...
	 * <tr><td>SDK_DEV_INTERVIDEO_CFG</td><td>platform input config,</td><td>lchannel means platform input type	lchannel=4,means bell platform,SDKDEV_INTERVIDEO_BELL_CFG. lchannel=10,means ZTE platform,SDKDEV_INTERVIDEO_NSS_CFG lchannel=11,means u CNC,SDKDEV_INTERVIDEO_UCOM_CFG.</td></tr>
	 ...
	 * @param lLoginID handle, return from {@link INetSDK#LoginWithHighLevelSecurity}
	 ...
	 * @param lLoginID r  {@link INetSDK#LoginWithHighLevelSecurity}的返回值
	 * @param pInParam 输入参数
	 * @param pOutParam 输出参数
	 * @param nWaitTime 超时时间
	 * @return true:成功, false: 失败
	 ...
	 * \if ENGLISH_LANG
	 * Get Configuration
	 * @param lLoginID lLoginID login handle, return from {@link INetSDK#LoginWithHighLevelSecurity}
	 ...
	 * \else
	 * 设置发射功率
	 * @param lLoginID return value of {@link INetSDK#LoginWithHighLevelSecurity}
	 * @param pstInParam 输入参数
	 * @param pstOutParam 输出参数
	 * @param nWaitTime 超时等待时间
	 * @return true:成功, false: 失败
	 ...
	 * @return true: success, false: failed
	 * \else
	 * 按黑白名单操作  pInParam 和pOutParam内存由用户申请释放
	 * @param lLoginID   {@link INetSDK#LoginWithHighLevelSecurity}的返回值
	 * @param pstInParam 输入参数 
	 * @param pstOutParam 输出参数
	 * @param nWaitTime 超时等待时间
	 ...
	 * @param pstuInParam 西欧报警主机获取操作输入参数
	 * @param pstuOutParam 西欧报警主机获取操作输出参数
	 * @param nWaitTime 等待时间
	 * @return true:成功, false:失败
	 * \endif
	 */
	 ...
	 * @param pstuInParam 西欧报警主机设置操作输入参数
	 * @param pstuOutParam 西欧报警主机设置操作输出参数
	 * @param nWaitTime 等待时间
	 * @return true:成功, false:失败
	 * \endif
	 */
     ...
     * 开始实时监视并指定回调数据格式
     * @param lLoginID {@link INetSDK#LoginWithHighLevelSecurity}的返回值
     * @param pstuInParam 开始实时监视并指定回调数据格式输入参数
     * @param pstuOutParam 开始实时监视并指定回调数据格式输出参数
     * @param nWaitTime 等待时间
     ...
     * @return true:success, false:failed
     * \else
     * 设置实时监视加密数据回调,给用户提供设备流出的数据,当cbRealData为NULL时结束回调数据
     * @param lRealHandle {@link INetSDK#RealPlay}的返回值
     * @param cbRealData 回调函数,用于传出设备流出的实时数据
     * @return true:成功, false:失败
     * \endif
