...
/**
 * \if ENGLISH_LANG
 * Event type {@link FinalVar#EVENT_IVS_TRAFFIC_BACKING} (traffic backing)corresponding data block description info
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_TRAFFIC_BACKING} (违章倒车事件)对应的数据块描述信息
 * \endif
 */
