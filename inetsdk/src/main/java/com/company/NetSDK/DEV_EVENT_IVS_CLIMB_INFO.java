...
/**
 * \if ENGLISH_LANG
 * Event type {@link FinalVar#EVENT_IVS_CLIMBDETECTION} (climb check)corresponding data block description info
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_CLIMBDETECTION} (攀高检测事件)对应数据块描述信息
 * \endif
 */
