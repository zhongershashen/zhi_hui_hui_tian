...
/**
 * \if ENGLISH_LANG
 * the describe of {@link FinalVar#EVENT_IVS_TAKENAWAYDETECTION}'s data
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_TAKENAWAYDETECTION} (物品搬移事件)对应的数据块描述信息
 * \endif
 */
public class DEV_EVENT_TAKENAWAYDETECTION_INFO implements Serializable {
	/**
	 *
	 */
