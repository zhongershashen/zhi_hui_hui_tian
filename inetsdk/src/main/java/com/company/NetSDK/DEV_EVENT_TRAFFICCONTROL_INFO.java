...
/**
 * \if ENGLISH_LANG
 * Event type {@link FinalVar#EVENT_IVS_TRAFFICCONTROL}(traffic control)corresponding data block description info
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_TRAFFICCONTROL} (交通管制事件)对应的数据块描述信息
 * \endif
 */
