...
/**
 * \if ENGLISH_LANG
 * Event type {@link FinalVar#EVENT_IVS_TRAFFIC_PARKINGONYELLOWBOX} (parking on yellow)corresponding data block description info
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_TRAFFIC_PARKINGONYELLOWBOX} (黄网格线抓拍事件)对应的数据块描述信息
 * \endif
 */
