...
/**
 * \if ENGLISH_LANG
 * corresponding to interface {@link INetSDK#ControlDevice}, corresponding to command {@link CtrlType#SDK_VIHICLE_WIFI_ADD}
 * \else
 * 对应接口 {@link INetSDK#ControlDevice}, 对应命令{@link CtrlType#SDK_VIHICLE_WIFI_ADD}
 * \endif
 */
