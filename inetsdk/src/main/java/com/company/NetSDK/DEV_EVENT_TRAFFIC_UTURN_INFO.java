...
/**
 * \if ENGLISH_LANG
 * the describe of  {@link FinalVar#EVENT_IVS_TRAFFIC_UTURN}'s data
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_TRAFFIC_UTURN}(违章调头事件)对应的数据块描述信息
 * \endif
 */
public class DEV_EVENT_TRAFFIC_UTURN_INFO implements Serializable {
	/**
	 *
	 */
