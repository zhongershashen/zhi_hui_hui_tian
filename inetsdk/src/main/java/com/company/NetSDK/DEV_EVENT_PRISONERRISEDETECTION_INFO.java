...
/**
 * \if ENGLISH_LANG
 * the describe of {@link FinalVar#EVENT_IVS_PRISONERRISEDETECTION}'s data
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_PRISONERRISEDETECTION} (看守所囚犯起身事件) 对应的数据块描述信息
 * \endif
 */
public class DEV_EVENT_PRISONERRISEDETECTION_INFO implements Serializable {
	/**
	 *
	 */
	...
	public DEV_EVENT_PRISONERRISEDETECTION_INFO() {
