...
public class NET_ALARM_MSG_HANDLE implements Serializable {
     ...
     * \endif
     */
    public NET_CFG_EVENT_TITLE     	stuSnapshotTitle[] = new NET_CFG_EVENT_TITLE[FinalVar.MAX_VIDEO_CHANNEL_NUM];
    ...
    public boolean				abPlayTimes;                                    // 是否支持联动语音播放次数
    public boolean				abReboot;                                        // 是否支持重启使能
    public boolean				abBeepTime;                                     // 是否支持蜂鸣时长
    ...
    public boolean				          bReboot;                                        //重启使能TRUE:使能 FALSE:不使能
    public int                                 nBeepTime;                                      //蜂鸣时长最大值为3600，0代表持续蜂鸣
    public boolean				      abAudioLinkTime;								// 联动语音时间使能
    public int								nAudioLinkTime;									// 联动语音播放的时间, 单位：秒
    public boolean				abAudioPlayTimes;								// 联动语音播放使能
