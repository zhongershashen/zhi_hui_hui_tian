...
public class MEDIAFILE_TRAFFICCAR_INFO implements Serializable {
	...
	/**
	 * \if ENGLISH_LANG
	 * lane number, refer to {@link MEDIA_QUERY_TRAFFICCAR_PARAM}
	 * \else
	 * 车道,参见 {@link MEDIA_QUERY_TRAFFICCAR_PARAM}
	 * \endif
	 */
	public byte                byLane;
	...
	/**
	 * \if ENGLISH_LANG
	 * direction, refer to {@link MEDIA_QUERY_TRAFFICCAR_PARAM}
	 * \else
	 * 车道方向,参见 {@link MEDIA_QUERY_TRAFFICCAR_PARAM}
	 * \endif
	 */
