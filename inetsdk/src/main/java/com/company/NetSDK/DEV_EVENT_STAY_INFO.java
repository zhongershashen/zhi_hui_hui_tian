...
/**
 * \if ENGLISH_LANG
 * the describe of {@link FinalVar#EVENT_IVS_STAYDETECTION}'s data
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_STAYDETECTION} (停留事件)对应的数据块描述信息
 * \endif
 */
public class DEV_EVENT_STAY_INFO implements Serializable {
	/**
	 *
	 */
