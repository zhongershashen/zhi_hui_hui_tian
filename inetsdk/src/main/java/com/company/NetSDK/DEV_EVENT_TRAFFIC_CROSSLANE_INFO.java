...
/**
 * \if ENGLISH_LANG
 * the describe of {@link FinalVar#EVENT_IVS_TRAFFIC_CROSSLANE}'s data
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_TRAFFIC_CROSSLANE}(交通违章-违章变道)对应的数据块描述信息
 * \endif
 */
public class DEV_EVENT_TRAFFIC_CROSSLANE_INFO implements Serializable {
	/**
	 *
	 */
