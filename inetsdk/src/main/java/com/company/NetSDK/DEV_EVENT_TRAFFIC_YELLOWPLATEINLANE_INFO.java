...
/**
 * \if ENGLISH_LANG
 * the describe of {@link FinalVar#EVENT_IVS_TRAFFIC_YELLOWPLATEINLANE} 's data
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_TRAFFIC_YELLOWPLATEINLANE} (交通违章-黄牌车占道事件)对应的数据块描述信息
 * \endif
 */
