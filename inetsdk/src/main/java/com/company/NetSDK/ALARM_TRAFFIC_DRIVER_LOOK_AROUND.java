...
/**
 * \if ENGLISH_LANG
 *  alarm of traffic driver look around  Corresponding to {@link FinalVar#SDK_ALARM_TRAFFIC_DRIVER_LOOK_AROUND}
 * \else
 *  开车左顾右盼报警事件 对应 {@link FinalVar#SDK_ALARM_TRAFFIC_DRIVER_LOOK_AROUND}
 * \endif
 */
