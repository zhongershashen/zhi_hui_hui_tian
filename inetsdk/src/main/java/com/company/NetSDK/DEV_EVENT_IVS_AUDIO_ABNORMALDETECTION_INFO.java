...
/**
 * \if ENGLISH_LANG
 * Event type {@link FinalVar#EVENT_IVS_AUDIO_ABNORMALDETECTION} (audio abnormal detection)corresponding data block description info
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_AUDIO_ABNORMALDETECTION} (声音异常检测)对应数据块描述信息
 * \endif
 */
