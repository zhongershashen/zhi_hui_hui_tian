...
/**
 * \if ENGLISH_LANG
 * the describe of {@link FinalVar#EVENT_IVS_TAILDETECTION}'s data
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_TAILDETECTION} (聚众事件)对应的数据块描述信息
 * \endif
 */
public class DEV_EVENT_RIOTERL_INFO implements Serializable {
	/**
	 *
	 */
