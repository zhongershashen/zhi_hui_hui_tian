...
/**
 * \if ENGLISH_LANG
 * {@link EM_FILE_QUERY_TYPE#SDK_FILE_QUERY_FACE_DETECTION} corresponding face recognition service FINDNEXT search return parameter
 * \else
 * {@link EM_FILE_QUERY_TYPE#SDK_FILE_QUERY_FACE_DETECTION} 对应的人脸识别服务FINDNEXT查询返回参数
 * \endif
 */
