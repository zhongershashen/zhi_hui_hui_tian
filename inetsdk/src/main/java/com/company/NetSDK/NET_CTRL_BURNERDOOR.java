...
/**
 * \if ENGLISH_LANG
 * {@link INetSDK#ControlDevice} interface, the corresponding command {@link CtrlType#SDK_CTRL_CLOSE_BURNER}
 * \else
 * {@link INetSDK#ControlDevice} 接口的 {@link CtrlType#SDK_CTRL_CLOSE_BURNER} 等 命令参数
 * \endif
 */
