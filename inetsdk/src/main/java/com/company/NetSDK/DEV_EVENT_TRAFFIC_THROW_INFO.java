...
/**
 * \if ENGLISH_LANG
 * Event type {@link FinalVar#EVENT_IVS_TRAFFIC_THROW} (throw)corresponding data block description info
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_TRAFFIC_THROW} (交通抛洒物品事件)对应数据块描述信息
 * \endif
 */
public class DEV_EVENT_TRAFFIC_THROW_INFO implements Serializable {
	/**
	 *
	 */
