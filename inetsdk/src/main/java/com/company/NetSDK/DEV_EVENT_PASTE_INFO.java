...
/**
 * \if ENGLISH_LANG
 * the describe of{@link FinalVar#EVENT_IVS_PASTEDETECTION}'s data
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_PASTEDETECTION} (贴条事件)对应的数据块描述信息
 * \endif
 */
public class DEV_EVENT_PASTE_INFO implements Serializable {
	/**
	 *
	 */
