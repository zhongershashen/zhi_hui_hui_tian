...
/**
 * \if ENGLISH_LANG
 * Event type {@link FinalVar#EVENT_IVS_TRAFFIC_VEHICLEINBUSROUTE}(vehicle in bus route)corresponding data block description info
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_TRAFFIC_VEHICLEINBUSROUTE} (占用公交车道事件)对应的数据块描述信息
 * \endif
 */
