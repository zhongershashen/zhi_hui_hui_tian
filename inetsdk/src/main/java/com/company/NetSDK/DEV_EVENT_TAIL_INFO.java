...
/**
 * \if ENGLISH_LANG
 * Tail event, the corresponding {@link FinalVar#EVENT_IVS_TAILDETECTION}
 * \else
 * 尾随事件, 对应 {@link FinalVar#EVENT_IVS_TAILDETECTION}
 * \endif
 */
public class DEV_EVENT_TAIL_INFO implements Serializable {
	/**
	 *
	 */
