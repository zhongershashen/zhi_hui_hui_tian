...
/**
 * \if ENGLISH_LANG
 * Event type {@link FinalVar#EVENT_IVS_DENSITYDETECTION} (Population amount detect) corresponding data block description info
 * \else
 * 事件类型 {@link FinalVar#EVENT_IVS_DENSITYDETECTION} (人员密度检测)对应数据块描述信息
 * \endif
 */
