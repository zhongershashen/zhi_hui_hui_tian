...
public class P2PLoginActivity extends AppCompatActivity {
    ...
    private class P2PLoginTask extends AsyncTask<String, Integer, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            ...
            if(mP2pLoginModule.startP2pService(serverIp, serverPort, p2pUsername, p2pPassword,
                    p2pDeviceId, p2pDevicePort, p2pDeviceUsername, p2pDevicePassword)) {
        ...
        protected void onPostExecute(Boolean result){
            ...
            if(!mP2pLoginModule.isServiceStarted()) {
                ...
                if (result) {
                    ...
                    app.setDevName(mP2pLoginModule.getDeviceName());
    ...
    private void getSharePrefs() {
        ...
        mEditTextServerIp.setText(mSharedPrefs.getString(PrefsConstants.P2P_SERVER_IP, ""));
        mEditTextServerPort.setText(mSharedPrefs.getString(PrefsConstants.P2P_SERVER_PORT, ""));
        ...
        mEditTextP2pDevicePort.setText(mSharedPrefs.getString(PrefsConstants.P2P_DEVICE_PORT, ""));
        mEditTextP2pDeviceUsername.setText(mSharedPrefs.getString(PrefsConstants.P2P_DEVICE_USERNAME, ""));
        mEditTextP2pDevicePassword.setText(mSharedPrefs.getString(PrefsConstants.P2P_DEVICE_PASSWORD, ""));
